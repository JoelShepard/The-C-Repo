...
/* *
Function recursive per il merge di due array ordinati

Algoritmo:
1. Base case: se entrambi gli array sono vuoti, terminates
...
@param size_a    Size rimanente del primo array
@param size_b    Size rimanente del secondo array
